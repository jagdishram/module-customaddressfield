...
namespace Jag\CustomAddressField\Helper;
...
class Data extends AbstractHelper
{
     ...
     * @return array
     */
    public function getCustomAddressField($fieldset='extra_checkout_billing_address_fields', $root='global')
    {
    ...
    public function transportFieldsFromExtensionAttributesToObject(
        ...
        foreach ($this->getCustomAddressField($fieldset) as $extraField) {  
