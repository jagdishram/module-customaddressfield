...
namespace Jag\CustomAddressField\Block\Checkout;
...
class LayoutProcessor implements LayoutProcessorInterface
{
    ...
    public function getAdditionalFields($addressType='shipping')
    {
        if ($addressType=='shipping') {
            return $this->helper->getCustomAddressField('extra_checkout_shipping_address_fields');
        }
        return  $this->helper->getCustomAddressField('extra_checkout_billing_address_fields');
    }
